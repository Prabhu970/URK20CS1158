...
function up() {
    document.querySelector("hc").textContent = `${heads}`;
    document.querySelector("tc").textContent = `${tails}`;
}
function SLWfunc() {
...
function Flipthecoin() {
    ...
    document.getElementById("hc").innerHTML = 0;
    var t = 0;
    var h = 0;
    var list = ["Tail.jpg", "Head.jpg"];

    var rand1 = Math.floor(Math.random() * 2);
    var im1 = "<img src=" + list[rand1] + " width = 100 height = 100 ></img>";
    if (list[rand1] == "Tail.jpg") {
        t++;
    }
    else {
        h++;
    ...
    document.getElementById("tc").innerHTML = document.getElementById("tc").value + t;
    document.getElementById("hc").innerHTML = document.getElementById("hc").value + h;
}*/
